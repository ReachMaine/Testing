				...
				<div class="listing-system">
					<div class="listing-system-row">
						...
						<div class="listing-system-row-image">
							<a href="<?php the_permalink(); ?>" style="background-image: url('<?php if ( has_post_thumbnail() ) : ?><?php echo esc_attr( $image[0] ); ?><?php else : ?><?php echo get_stylesheet_directory_uri(); ?>/images/default-item.jpg<?php endif; ?>')">

<?php /* zig  moved all the pieces that we are using up to description box.
*/ ?>
<?php if ( false && apply_filters( 'inventor_metabox_allowed', true, 'contact', get_the_author_meta('ID') ) && isset( $fields ) ): ?>
